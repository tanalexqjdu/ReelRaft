 ...
 * This file demonstrates how to integrate Reelraft with a web frontend
 */

// For React/Vue/Angular applications
export class ReelraftClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ReelraftClient(provider, contractAddress);
